...
export default function Visualization(props) {
  ...
  const allModules = [
    ...
    { moduleName: 'Splunk & Visualization Course (Udemy)', points: 15 },
    { moduleName: 'Quiz: Visualization Tool Features', points: 10 },
    { moduleName: 'Advanced Incident Response (Lab)', points: 25 },
    { moduleName: 'Quiz: Log Analysis & Threat Detection', points: 10 },
    { moduleName: 'Final Project: Dashboard Story', points: 30 },
  ...
  const handleCompleted = async (moduleName, pointsEarned) => {
    ...
    if (!isCompleted) {
      ...
      props.updateModule(3, moduleName);
      ...
      {loading ? (
        ...
        <div className="learning-plan w-[64.5rem] tracking-wider">
          ...
          <a
            className="module module-left flex flex-col items-center"
            style={{ gridRow: 5 }}
            href="https://trianglecyber.udemy.com/course/splunker/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div
