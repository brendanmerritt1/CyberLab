      ...
      <div className="learning-plan w-[64.5rem] tracking-wider">
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Digital Forensics Fundamentals (Udemy)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: Digital Forensics Key Concepts</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">File System Analysis (Lab)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Memory Forensics Course (Udemy)</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Analyze a Memory Dump (Lab)</span>
            <span className="p-5 text-yellow-400">15 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Simulated Data Exfiltration (Exercise)</span>
            <span className="p-5 text-yellow-400">15 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: Memory and Network Forensics</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Final Project: Forensic Case Study</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            ...
            <span className="p-5 text-yellow-400">175 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
          </div>
