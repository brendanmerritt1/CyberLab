      ...
      <div className="learning-plan w-[64.5rem] tracking-wider">
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">DevOps Fundamentals Course (Udemy)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: DevOps Lifecycle Stages & Tools</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Simple Python Automation (Lab)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: Python Basics for Automation</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">DevSecOps Pipeline Implementation (Lab)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: DevOps vs. DevSecOps</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Final Project: Build a Secure CI/CD Pipeline</span>
