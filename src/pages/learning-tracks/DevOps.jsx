...
export default function DevOps(props) {
  ...
  const allModules = [
    { moduleName: 'DevOps Fundamentals Course (Udemy)', points: 10 },
    { moduleName: 'Quiz: DevOps Lifecycle Stages & Tools', points: 15 },
    { moduleName: 'Simple Python Automation (Lab)', points: 15 },
    { moduleName: 'Quiz: Python Basics for Automation', points: 10 },
    { moduleName: 'DevSecOps Pipeline Implementation (Lab)', points: 25 },
    { moduleName: 'Quiz: DevOps vs. DevSecOps', points: 10 },
    { moduleName: 'Final Project: Build a Secure CI/CD Pipeline', points: 30 },
  ...
  const handleCompleted = async (moduleName, pointsEarned) => {
    ...
    if (!isCompleted) {
      ...
      props.updateModule(4, moduleName);
      ...
      {loading ? (
        ...
        <div className="learning-plan w-[64.5rem] tracking-wider">
          <a
            ...
            style={{ gridRow: 1 }}
            href="https://trianglecyber.udemy.com/course/the-devops-essentials/"
            target="_blank"
