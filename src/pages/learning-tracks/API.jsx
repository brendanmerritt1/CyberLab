      ...
      <div className="learning-plan w-[64.5rem] tracking-wider">
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">API Security Course (ACloudGuru)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: Common API Vulnerabilities</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">API Security (Lab)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Zero Trust Implementation (Lab)</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: Zero-Trust Concepts</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Secure API Dev Practices (Udemy)</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Quiz: Security in API Dev</span>
            <span className="p-5 text-yellow-400">10 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            <span className="p-5">Final Project: Secure API Design</span>
        ...
        >
          <div className="flex h-[6rem] w-[28rem] flex-row items-center rounded-2xl bg-[#505d96] text-center">
            ...
            <span className="p-5 text-yellow-400">150 Points</span>
            <span className="mr-5 cursor-pointer rounded-2xl border-2 border-green-400 p-2 text-green-400 hover:bg-gray-600">
              Mark Completed
            </span>
          </div>
